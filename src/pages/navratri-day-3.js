                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      router.push(`/navratri-day-3?lang=${e.target.value}`);
                    }}
                    className="appearance-none bg-white border border-gray-200 text-gray-700 px-4 py-2 pr-10 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 font-medium shadow-sm"
                  >
                    {languages.map(lang => (
              ...
              <div className="bg-white rounded-lg px-4 py-3 border border-gray-200 shadow-sm">
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center space-x-2">
                    <div className="w-4 h-4 bg-yellow-500 border-2 border-gray-400 rounded-full"></div>
                    <span className="font-semibold text-gray-800 text-sm">{t.yellow}</span>
                  </div>
                </div>
              </div>
            </div>
