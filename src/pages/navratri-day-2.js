          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      router.push(`/navratri-day-2?lang=${e.target.value}`);
                    }}
              ...
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent">
                  {t.goddess}
                </h2>
              ...
              <div className="bg-white rounded-lg px-4 py-3 border border-gray-200 shadow-sm">
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center space-x-2">
                    <div className="w-4 h-4 bg-red-500 border-2 border-gray-400 rounded-full"></div>
