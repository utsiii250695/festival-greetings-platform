    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-teal-50">
        ...
        <div className="max-w-4xl mx-auto px-4 pb-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-teal-100">
            ...
            <div className="space-y-6 sm:space-y-8">
              {currentContent.content.map((section, index) => (
                <div key={index} className="relative">
                  {/* Section */}
                  <div className="bg-gradient-to-r from-white to-teal-50 rounded-xl p-6 mb-4 border border-teal-100">
                  ...
                  {/* Anecdote Box */}
                  <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl p-5 border-l-4 border-teal-500 ml-4">
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-8 border border-teal-200">
                ...
                <p className="text-teal-600 text-lg mb-6 max-w-2xl mx-auto">
                  {t.blessingDesc}
                </p>

                <div className="bg-white rounded-xl p-6 shadow-lg max-w-md mx-auto border border-teal-200">
                  <h4 className="font-bold text-gray-800 mb-3">{t.todaysMantra}</h4>
                  <div className="text-lg font-semibold text-teal-700 sanskrit mb-2">
          ...
          <div className="mt-12 text-center">
            <div className="inline-block bg-white rounded-2xl shadow-lg p-6 border border-teal-200">
              <p className="text-gray-600 mb-4">{t.continueJourney}</p>
              <button
                onClick={() => router.push(`/navratri-day-9?lang=${currentLang}`)}
                className="px-8 py-4 bg-gradient-to-r from-teal-500 to-pink-500 text-white font-semibold rounded-xl hover:from-teal-600 hover:to-pink-600 transition-all duration-200 transform hover:scale-105 shadow-lg"
              >
                {t.day9Coming}
              </button>
            </div>
