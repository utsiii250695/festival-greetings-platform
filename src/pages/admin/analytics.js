            ...
            <div className="flex justify-between items-center py-6">
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="flex items-center px-3 py-2 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-all duration-200 border border-blue-200"
                >
                        ...
                        <div key={festival.name} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="font-medium text-gray-900">
                              {typeof festival.name === 'string' ? festival.name : JSON.stringify(festival.name)}
                            </span>
                          </div>
                      ...
                      {analyticsData.popularTemplates.map((template, index) => (
                        <div key={template.name} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="font-medium text-gray-900">
                              {typeof template.name === 'string' ? template.name : JSON.stringify(template.name)}
                            </span>
                          </div>
